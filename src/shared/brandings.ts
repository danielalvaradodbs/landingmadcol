...
import PluxeeHover from '../assets/images/brandings/Proyecto_Sodexo_Pluxee_hover.avif';
...
export const brandings = [
    {
        image: VaxTrial,
        altImage: 'VaxTrial',
        info: 'brandings.vax.info',
        title: 'brandings.vax.title',
        description: 'brandings.vax.description',
        linkButton: 'https://www.behance.net/gallery/217026631/Lifting-Brand-Vax-Trials',
        imageHover: VaxTrialHover,
        isDark: true,
    },
    {
        image: Pluxee,
